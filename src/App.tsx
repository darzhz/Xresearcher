...
import { XReChat } from './components/XReChat'
        ...
        <div className="max-w-7xl mx-auto">
          {activeView === 'inbox' && (
            <div className="newsprint-grid bg-paper">
              <InboxView onOpenPaper={handleOpenPaper} library={library} />
            </div>
          )}
                ...
                <div className="lg:col-span-3 border-ink border-r border-b p-6 sm:p-10 bg-paper">
                  ...
                  <div className="mt-16 border-t-2 border-ink/10 pt-12">
                    <div className="mb-6 flex items-center gap-4">
                      <div className="h-8 w-2 bg-ink" />
                      <h2 className="font-mono uppercase tracking-[0.2em] text-sm font-bold">XReChat In-Document Traversal</h2>
                    </div>
                    <XReChat paperId={readerPaper.id} initialized={initialized} />
                  </div>
                  </div>
      ...
      <footer className="border-t-4 border-ink mt-20 bg-paper py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 border-ink border-l border-t newsprint-grid">
          <div className="p-8">
             ...
             <p className="text-sm text-ink/60 italic">An edge-computing research environment designed for local statistical inference and deep analysis of scientific literature.</p>
          </div>
          <div className="p-8">
